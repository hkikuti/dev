   ...
   *#####################################################*/
  {
    ...
    datalist : [
      ...
      },
      {
        "title" : "チェックスタイルについて",
        "data" : [
            "本規約で定めたコーディングスタイルのうち、一部はCheckstyleにより自動チェックされる。",
            "規約に違反するコードは保存時に警告が表示されるため、警告が出ないよう修正することを原則とする。",
            "ただし、実務上、警告が多発することが予測されるルールや、開発効率を著しく損なうと判断したものについては、",
            "Checkstyleによる強制チェックを行っていない。",
            "これらのルールについても本規約に記載されている場合があるが、自動で検出されない場合でも、可能な限り遵守することが望ましい。",
            "どの規約がCheckstyleのチェック対象であるかは、以下のアイコンの有無で判別できる。",
            "<div class=checkstyle>checkstyle</div>",
            "&nbsp;",
            "なお、IDEでCheckstyleの警告が表示されない場合は、Checkstyleプラグインが有効になっているか確認すること。",
        ]
      }
    ]
  },
